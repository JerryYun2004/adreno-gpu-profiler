...
#define ADRENO_SP_BUSY_CYCLES 1
#define ADRENO_SP_ALU_WORKING_CYCLES 2
...
int main(void) {
  ...
  counters[1].countable_selector = ADRENO_SP_ALU_WORKING_CYCLES;
